...
export default function InfoMain(props) {
    ...
    return (
        <>
            <button className="home-button no-border padding-inline cursor-pointer border-radius box-shadow space-around-content elements-color input-color fs-small fw-medium letter-spacing" onClick={() => navigate('/rest-countries-api')}>Home</button>
